...
// FyberSDK
#define COCOAPODS_POD_AVAILABLE_FyberSDK
#define COCOAPODS_VERSION_MAJOR_FyberSDK 7
#define COCOAPODS_VERSION_MINOR_FyberSDK 2
#define COCOAPODS_VERSION_PATCH_FyberSDK 5
